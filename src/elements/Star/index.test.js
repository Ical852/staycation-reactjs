...
test('Should have props [value, height, width, spacing]', () => {
    ...
    expect(container.querySelector("div.stars"))
        .toHaveAttribute('style', expect.stringContaining(`height: ${height}px`))
    expect(container.querySelector(starYellow)).toBeInTheDocument()
    expect(container.querySelector(starYellow))
        .toHaveAttribute('style', expect.stringContaining(`width: ${width}px`))
    expect(container.querySelector(starYellow))
        .toHaveAttribute('style', expect.stringContaining(`height: ${height}px`))
    expect(container.querySelector(starYellow))
        .toHaveAttribute('style', expect.stringContaining(`margin-right: ${spacing}px`))
})